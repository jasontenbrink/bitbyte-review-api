exports.up = async knex => {
    await knex.raw(`ALTER TABLE vendors ADD COLUMN email varchar(100)`)

    await knex.raw(`
    CREATE VIEW vendors_with_reviews AS
...
exports.down = async knex => {
    await knex.raw(`DROP VIEW vendors_with_reviews`)
    await knex.raw(`ALTER TABLE vendors DROP COLUMN email`)
}
